...
use semsimian::termset_pairwise_similarity::{TermsetPairwiseSimilarity as Tsps, TermsetPairwiseSimilarity};
...
#[get("/search/<termset>/<prefix>")]
// pub fn full_search() {
pub fn search(termset: &str, prefix: &str) -> Json<Vec<(f64, Option<TermsetPairwiseSimilarity>, TermID)>> {
